...
function TotpDialog({ account, onClose, onSaved }: { account: TikTokAccount; onClose: () => void; onSaved: () => void }) {
  ...
  useEffect(() => { if (account.has_totp) void loadCode(); }, [account.id, account.has_totp]);
