...
const actionLabels: Record<string, string> = {
  ...
  ACCOUNT_TOTP_CONFIGURED: "Thiết lập 2FA",
  ACCOUNT_TOTP_REMOVED: "Xóa thiết lập 2FA",
...
const systemActionLabels: Record<string, string> = {
  ...
  ACCOUNT_TOTP_CONFIGURED: "Thiết lập xác thực 2 lớp cho kênh",
  ACCOUNT_TOTP_REMOVED: "Gỡ xác thực 2 lớp khỏi kênh",
